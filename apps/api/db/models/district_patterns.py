...
class DistrictPattern(Base):
    __tablename__ = "district_patterns"
    __table_args__ = (
        Index("ix_district_patterns_org_id", "org_id"),
        Index("ix_district_patterns_district_key", "district_key"),
        Index("ix_district_patterns_period_start", "period_start"),
    )
    ...
    top_schemes: Mapped[list] = mapped_column(
        JSONB, nullable=False, server_default="'[]'::jsonb"
    )
    top_themes: Mapped[list] = mapped_column(
        JSONB, nullable=False, server_default="'[]'::jsonb"
    )
